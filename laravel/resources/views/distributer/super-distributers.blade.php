        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Super Distributers List</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        @endif
                        <div class="left_head">
                            <h3 class="header smaller lighter blue">Super Distributers</h3>
                        </div>
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                @if($user_role == "admin" || $user_role == "sub-admin"  || $user_role == "master-distributer")
                                                    <a class="green" href="{{ route('edit-super-distributer',['id'=> $user->id]) }}">
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Delete Super-distributer Parmanently</h4>
                                                  </div>
                                                  <div class="modal-body">
                                                    <p>Are you sure you want to delete this Super Distributer ?</p>
                                                  </div>
                                                  <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                    <a href="{{ route('delete-super-distributer', ['id' => $user->id]) }}" class="btn btn-danger" id="confirm">Delete</a>
