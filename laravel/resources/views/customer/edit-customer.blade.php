                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('update-customer', ['id' => $customer->id]) }}">
                                    {{ method_field('PUT') }}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select id="is_active" name="is_active" class="form-control">
                                                <option value="1" @if($customer['is_active'] == 1) selected="selected" @endif>Active</option>
                                                <option value="0" @if($customer['is_active'] == 0) selected="selected" @endif>Deactive</option>
                                            </select>
                                        </div>
                                    </div>
