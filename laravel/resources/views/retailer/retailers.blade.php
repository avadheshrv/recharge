        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Retailers List</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        @endif
                         <div class="left_head">
                           <h3 class="header smaller lighter blue">Retailers</h3>
                        </div>
                        ...
                        @if($user_role == "admin" || $user_role == "sub-admin"  || $user_role == "master-distributer" || $user_role == "super-distributer" || $user_role == "distributer") 
                         <div class="add_btn">
                            <a href="{{ url('/admin/add-retailer') }}" class="btn-sm btn-info no-radius">Add Retailer</a>
                        </div>
                        @endif
                        <div class="clearfix">
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <div class="hidden-sm hidden-xs action-buttons">
                                               ...
                                               @if($user_role == "admin" || $user_role == "sub-admin"  || $user_role == "master-distributer" || $user_role == "super-distributer" || $user_role == "distributer") 
                                                <a class="green" href="{{ route('edit-retailer',['id'=> $user->id]) }}">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a class="red" href="#" data-toggle="modal" data-target="#confirmDelete_{{ $user->id }}" data-title="Delete User" data-message="Are you sure you want to delete this Retailer ?">
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Delete Retailer Parmanently</h4>
                                                  </div>
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('delete-retailer', ['id' => $user->id]) }}" class="btn btn-danger" id="confirm">Delete</a>
