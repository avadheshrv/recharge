                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="red" href="#" data-toggle="modal" data-target="#confirmDelete" data-title="Delete User" data-message="Are you sure you want to delete this Sub admin ?">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                 <form role="form" method="POST" action="{{ route('delete-subadmin') }}">
